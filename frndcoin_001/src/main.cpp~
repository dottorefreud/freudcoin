...
uint256 hashGenesisBlock("0x000000005dc50c7b3df5a6fbd73b0ea61a643970a9d30c93aa52b838d0914b4a");
...
const string strMessageMagic = "Freudcoin Signed Message:\n";
...
static const int64 nTargetTimespan = 2016 * 60; //
static const int64 nTargetSpacing = 1 * 60; // 1 min
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("000000005dc50c7b3df5a6fbd73b0ea61a643970a9d30c93aa52b838d0914b4a");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "hello world! i am freud. i am human";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04eb709453f921efc2e2a5c7b9baaae2593aca93f27ceb5b8045f9d5503bb896c158d00fd955fa776e200810a4c66155854b057ae24731dc66446de7b44056b8ae") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1526364000;
        block.nBits    = 0x1d00ffff;
        block.nNonce   = 1585591263;
        ...
        assert(block.hashMerkleRoot == uint256("0x5a791cbb6e7ae470e1f1cb0becf474ed5f842170bbd2bf25f0667c61c4deb5ed"));
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("FreudcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("FreudcoinMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static FreudcoinMiner(CWallet *pwallet)
{
    printf("FreudcoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("freudcoin-miner");
    ...
    try { loop {
        ...
        printf("Running FreudcoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("FreudcoinMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&FreudcoinMiner, pwallet));
}
